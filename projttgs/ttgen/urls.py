...
urlpatterns = [
    ...
    path("delete-section-subject-mapping/<int:mapping_id>/", views.delete_section_subject_mapping, name="delete_section_subject_mapping"),
    ...
    path('live_timetables/<int:tid>/room-utilization/', views.live_room_utilization_analysis, name='live_room_utilization_analysis'),
    path('live_timetables/<int:tid>/room-utilization/pdf/', views.live_room_utilization_pdf, name='live_room_utilization_pdf'),
    path('live_timetables/<int:tid>/room-utilization/excel/', views.live_room_utilization_excel, name='live_room_utilization_excel'),
    path('live_timetables/<int:tid>/rename/', views.rename_live_timetable, name='rename_live_timetable'),
    path('live_timetables/<int:tid>/lock/', views.lock_live_timetable, name='lock_live_timetable'),
    path('live_timetables/<int:tid>/unlock/', views.unlock_live_timetable, name='unlock_live_timetable'),
