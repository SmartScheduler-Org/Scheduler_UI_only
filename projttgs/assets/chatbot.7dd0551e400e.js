// ============================================================
//  ScheduloAI Chatbot — Client-Side Knowledge Base + UI Engine
...
(function () {
  ...
  const KB = [
    ...
    // ─── TEAM / FOUNDERS ───
    {
      ...
      answer: "ScheduloAI was built by a passionate team of 4 developers:\n\n👨‍💻 **Sanjeevan** — Co-founder & Developer\n👩‍💻 **Ishaanvi** — Co-founder & Developer\n👨‍💻 **Tushar** — Co-founder & Developer\n👨‍💻 **Pramod** — Co-founder & Developer\n\nTogether they form **Team ScheduloAI** — driven by the mission of solving real-world academic scheduling problems using AI and optimization algorithms. They've experienced the pain of manual timetabling firsthand and built this platform to eliminate it for every institution.\n\n📞 Want to connect with the team? Call **8406043847**",
      priority: 10
    },
    {
      tags: ["sanjeevan"],
      answer: "**Sanjeevan** is one of the 4 co-founders and developers of ScheduloAI. He is part of **Team ScheduloAI** along with Ishaanvi, Tushar, and Pramod. Together they built this AI-powered timetable generation platform to solve the chaos of manual scheduling in educational institutions.\n\n📞 Reach the team: **8406043847**",
      priority: 12
    },
    {
      tags: ["ishaanvi"],
      answer: "**Ishaanvi** is one of the 4 co-founders and developers of ScheduloAI. She is part of **Team ScheduloAI** along with Sanjeevan, Tushar, and Pramod. Together they built this AI-powered timetable generation platform to solve the chaos of manual scheduling in educational institutions.\n\n📞 Reach the team: **8406043847**",
      priority: 12
    },
    {
      tags: ["tushar"],
      answer: "**Tushar** is one of the 4 co-founders and developers of ScheduloAI. He is part of **Team ScheduloAI** along with Sanjeevan, Ishaanvi, and Pramod. Together they built this AI-powered timetable generation platform to solve the chaos of manual scheduling in educational institutions.\n\n📞 Reach the team: **8406043847**",
      priority: 12
    },
    {
      tags: ["pramod"],
      answer: "**Pramod** is one of the 4 co-founders and developers of ScheduloAI. He is part of **Team ScheduloAI** along with Sanjeevan, Ishaanvi, and Tushar. Together they built this AI-powered timetable generation platform to solve the chaos of manual scheduling in educational institutions.\n\n📞 Reach the team: **8406043847**",
      priority: 12
    },
    ...
    // ─── TAGLINE ───
    {
      ...
      answer: "Our tagline is: **'Timetables without chaos. Done in seconds.'**\n\nIt perfectly captures what ScheduloAI does — replaces weeks of stressful manual work with a single click that generates an optimized, clash-free timetable in 3-8 seconds. No chaos. No conflicts. Just smart scheduling.",
      priority: 3
    },
  ...
  function findBestAnswer(query) {
    ...
    // Minimum threshold
    if (bestScore < 5) {
      return "Hmm, I don't have a specific answer for that. I'm trained to answer questions about the **ScheduloAI platform** — here's what I know best:\n\n🔹 **\"How does the platform work?\"**\n🔹 **\"What features does it have?\"**\n🔹 **\"How do I get started?\"**\n🔹 **\"What is the pricing?\"**\n🔹 **\"Who built ScheduloAI?\"**\n🔹 **\"How can I join the team?\"**\n\nFor anything else, our team can help personally:\n📞 **Helpline: 8406043847** (Sanjeevan, Ishaanvi, Tushar & Pramod)";
    }
  ...
  function createChatbotUI() {
    ...
    win.innerHTML = '<div class="scheduloai-chat-header"><div class="scheduloai-chat-avatar">AI</div><div class="scheduloai-chat-header-info"><div class="scheduloai-chat-header-title">ScheduloAI Assistant</div><div class="scheduloai-chat-header-subtitle"><span class="dot"></span> Online — Instant responses</div></div></div><div class="scheduloai-chat-messages" id="scheduloai-msgs"></div><div class="scheduloai-quick-actions" id="scheduloai-quick"></div><div class="scheduloai-chat-input-area"><input class="scheduloai-chat-input" id="scheduloai-input" type="text" placeholder="Ask me anything about ScheduloAI..." autocomplete="off" /><button class="scheduloai-chat-send" id="scheduloai-send" aria-label="Send"><svg viewBox="0 0 24 24"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg></button></div>';
